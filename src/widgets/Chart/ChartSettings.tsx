import { AnchorButton, Button, Card, Classes, Dialog, H4, Label, MenuItem, Switch } from "@blueprintjs/core";
import { useCallback, useEffect, useState } from "react";
import { useTheme } from "../../ThemeContext";
import React from 'react';
import { Select } from "@blueprintjs/select";
import { CHART_METRICS, CHART_RANGE, CHART_TYPE_OF_CHART, filterOption, IOption, renderOption } from "./options";
    ...
    return (
        ...
        <div className="settings-container" style={cogIconContainerStyle}>
            <AnchorButton
                    ...
                    <Dialog className={theme === "dark" ? "bp3-dark" : ""} icon="info-sign" title={"Ustawienia"}
                ...
                <div className={Classes.DIALOG_BODY}>
                            <Card>
                                ...
                                <Label style={optionRowStyle}>
                                    ...
                                    <div>
                                        <Switch checked={additionalSerie} label={additionalSerie ? 'On' : 'Off'} onChange={() => setAdditionalSerie(!additionalSerie)} />
                                    </div>
                                </Label>
                            </Card>
                </div>
